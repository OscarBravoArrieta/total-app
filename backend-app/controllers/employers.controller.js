 ...
 export async function getAll(req, res) {
     ...
     try {
         const employers = await sequelize.query(
             ...
             `SELECT * FROM employers WHERE CODIGO_ESTADO IN (?) AND ${whichDateField} BETWEEN ? AND ?`, //Call employers view
             { 
         ...
         console.log('Se presentó el siguiente error al obtener Empleadores...', error);
     } 
 }    
 //------------------------------------------------------------------------------------------------
